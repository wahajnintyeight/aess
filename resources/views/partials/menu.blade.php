            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Payments">
                        ...
                        @if (Qs::userIsTeamAccount())
                            <li
                                class="nav-item {{ in_array(Route::currentRouteName(), ['payments.index', 'payments.create', 'payments.edit', 'payments.manage', 'payments.show', 'payments.invoice']) ? 'nav-item-expanded' : '' }}">
