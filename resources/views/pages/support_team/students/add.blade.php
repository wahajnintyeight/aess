                ...
                <div class="row">
                    ...
                    <div class="col-md-3" style="display: none">
                        <div class="form-group">
                            ...
                            {{-- <select data-placeholder="Choose..." name="nal_id" id="nal_id"
                            ...
                            <input type="text" name="nal_id" hidden value="136">
                        </div>
                    </div>

                    <div class="col-md-3" style="display: none">
                        <label for="state_id">State: <span class="text-danger">*</span></label>
                        <select onchange="getLGA(this.value)" data-placeholder="Choose.." class="select-search form-control"
                            name="state_id" id="state_id">
                            <option value="2"></option>
                            @foreach ($states as $st)
                                <option {{ old('state_id') == $st->id ? 'selected' : '' }} value="Punjab">
                                    {{ $st->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-3" style="display: none">
                        ...
                        <select data-placeholder="Select State First" class="select-search form-control" name="lga_id"
                            id="lga_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select form-control" id="bg_id" name="bg_id" data-fouc
                                ...
                                @foreach (App\Models\BloodGroup::all() as $bg)
                                    <option {{ old('bg_id') == $bg->id ? 'selected' : '' }} value="3">
                                        {{ $bg->name }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" style="display: none">
                        <div class="form-group">
                            ...
                            <input type="text" name="my_parent_id" value="2" hidden>
                        </div>
                    </div>
