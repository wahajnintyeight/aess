...
Route::get('/privacy-policy', 'HomeController@viewLanding')->name('privacy_policy');
Route::get('/terms-of-use', 'HomeController@terms_of_use')->name('terms_of_use');
Route::get('/main', 'HomeController@viewLanding')->name('landing');
        ...
        function () {
            ...
            Route::group(
                ...
                function () {
                        ...
                        /*************** Time Slots *****************/
                        Route::group(
                            ['prefix' => 'time_slots', 'middleware' => 'teamSA'],
                            function () {
